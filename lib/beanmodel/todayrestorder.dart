...
class TodayRestaurantOrderDetails {
  ...
  @override
  String toString() {
    return '{product_name: $product_name, price: $price, unit: $unit, quantity: $quantity, product_image: $product_image, description: $description, varient_id: $varient_id, store_order_id: $store_order_id, qty: $qty,user_id: $user_id}';
  }
}
