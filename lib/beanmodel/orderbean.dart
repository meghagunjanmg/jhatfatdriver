...
class OrderDeatisSub {
  ...
  @override
  String toString() {
    return 'OrderDeatisSub{product_name: $product_name, price: $price, unit: $unit, quantity: $quantity, varient_image: $varient_image, description: $description, varient_id: $varient_id, store_order_id: $store_order_id, qty: $qty, total_items: $total_items,vendor_id: $vendor_id,vendor_name: $vendor_name,lat: $lat,lng: $lng,vendor_loc: $vendor_loc,vendor_phone: $vendor_phone';
  }
}
