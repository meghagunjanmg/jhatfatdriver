      ...
      body: Stack(
        children: [
          ...
          Align(
            ...
            child: Text("Signature here",style: TextStyle(color: Colors.grey),
            ),
          ),
                  ...
                  onTap: () {
                    if (paymentMethod == "COD") {
                      if ('${remprice}' == '${_cashController.text}') {
                        ...
                        Toast.show(
                            'you have filled incorrect amount..', context,
  ...
  void hitSevice(cartID, cashAmt, ProgressDialog pr, context) async {
    ...
    if (_controller != null && _controller.isNotEmpty) {
      ...
      if (paymentMethod != "COD") {
        ...
        if (cashAmt.toString() == '') {
          pr.hide();
          Toast.show('Please fill the amount you have received from customer.',
              context,
      ...
      pr.hide();
      Toast.show('Please tryagain!.', context,
          gravity: Toast.BOTTOM, duration: Toast.LENGTH_SHORT);
    }
  }
